...
class KhuyenMaiController extends Controller
{
    ...
    {
        $data = KhuyenMai::all();
        return response(view('admin.khuyenmai.khuyenmai', ['khuyenmais' => $data]));
    }
    ...
    {
        // Return the view for creating a new KhuyenMai
        return response(view('admin.khuyenmai.them'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->redirectTo('/admin/khuyenmai');
    }
    ...
    public function edit($id)
    {
        ...
        return response(View('admin.khuyenmai.sua', ['khuyenmai'=>$data]));
    }
