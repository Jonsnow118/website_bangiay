...
class DanhGiaController extends Controller
{
    ...
    {
        // Return a view or JSON response as appropriate
        return response()->json(['message' => 'DanhGia index']);
    }
    ...
    {
        // Return a view or JSON response as appropriate
        return response()->json(['message' => 'DanhGia create']);
    }
    ...
    public function store($id, Request $request)
    {
        ...
        return response()->redirectTo('/cua-hang/san-pham=' . $id);
    }
    ...
    {
        // Return a view or JSON response as appropriate
        return response()->json(['message' => 'DanhGia show', 'id' => $id]);
    }
    ...
    {
        // Return a view or JSON response as appropriate
        return response()->json(['message' => 'DanhGia edit', 'id' => $id]);
    }
    ...
    {
        // Implement update logic here or return a default response
    ...
    {
        // Implement delete logic or return a default response
