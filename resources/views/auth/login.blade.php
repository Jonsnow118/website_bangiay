...
<head>
    ...
    <title>Bitis SHOP | Đăng nhập</title>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-10 col-lg-7 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                <div class="text-center">
                                  <a href="/" style="color:Black; font-size:32px;font-weight:bold;font-family: var(--mdb-font-roboto);">Bitis Shop</a>
                                  <!-- <h4 >Restaurant Manager</h4> -->

                                  <img src="{{ URL('images1/logo-bitis.jpg') }}" class="img-fluid" alt="Sample image">
