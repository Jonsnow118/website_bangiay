...
<head>
    ...
    <title>Bitis</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL('images1/y-nghia-logo-bitis.png') }}">
...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/y-nghia-logo-bitis.png') }}" height="35" alt="PVB SHOP"
                    loading="lazy"></a>
                ...
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p>
                            ...
                            doanvietdung11804@gmail.com
                        </p>
                        <p><i class="fas fa-phone me-3"></i> +840824511140</p>
                    </div>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2025 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp;Bitis SHOP - Doan Viet Dung</a>
                </span>
            </div>
        </section>
    </footer>
